    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          onChange={onChange}
          placeholder="••••••••"
          className={`w-full pl-10 pr-11 py-3 rounded-xl bg-[#0F172A]/80 border text-white text-sm
            placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all ${error ? 'border-red-500 focus:border-red-500' : 'border-slate-700 focus:border-green-500'
            }`}
        />
        <button
          type="button"
          onClick={() => setShow(s => !s)}
          className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-200 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400"
...
function GoogleButton({ loading, onClick, label }) {
  return (
    <button
      ...
      onClick={onClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-white/5
        border border-slate-700/70 hover:bg-white/10 hover:border-slate-500 transition-all
  ...
  return (
    <div className="relative my-5">
      ...
      <div className="relative flex justify-center text-xs uppercase tracking-wider">
        <span className="bg-[#0F172A] px-3 text-slate-500 font-semibold">or</span>
      </div>
    </div>
  );
}
...
export default function WelcomeAuthPage({ onAuthSuccess, initialMode }) {
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  return (
    <div className="min-h-screen w-full bg-[#1E293B] text-slate-100 flex items-center justify-center p-4 sm:p-6 lg:p-12 relative overflow-hidden font-sans selection:bg-green-500 selection:text-white">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#94a3b812_1px,transparent_1px),linear-gradient(to_bottom,#94a3b812_1px,transparent_1px)] bg-[size:3.5rem_3.5rem] pointer-events-none" />
      <div className="absolute -top-48 left-1/4 w-96 h-96 bg-green-500/15 rounded-full blur-[128px] pointer-events-none" />
      <div className="absolute top-1/2 -right-48 w-96 h-96 bg-slate-400/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute -bottom-48 left-10 w-96 h-96 bg-slate-500/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center relative z-10 my-auto">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-8 order-2 lg:order-1 pt-4 lg:pt-0">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-green-500/15 border-2 border-green-500/60 shadow-lg shadow-green-500/10 flex items-center justify-center">
              <div className="w-full h-full bg-[#0F172A] rounded-[8px] flex items-center justify-center">
                <svg className="w-5 h-5 text-green-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <span className="text-lg font-bold tracking-tight text-white flex items-center gap-2">
                ...
                <span className="inline-flex items-center px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider rounded-full bg-green-500/10 text-green-400 border border-green-500/20">
                  v2.0 PRO
                </span>
              </span>
            </div>
          ...
          {/* Live chat demo card */}
          <div className="relative rounded-2xl bg-[#0F172A]/90 border-2 border-slate-700/60 p-5 shadow-2xl backdrop-blur-md max-w-xl">
            <div className="flex items-center justify-between border-b border-slate-800/80 pb-3 mb-4">
              ...
              <span className="text-[11px] text-green-400 font-medium bg-green-500/10 px-2 py-0.5 rounded-full border border-green-500/20">
                Avg Response: 1.2s
              </span>
            </div>
            <div className="space-y-3 text-xs">
              ...
              <div className="flex items-start gap-2 max-w-[90%] ml-auto flex-row-reverse">
                <div className="w-6 h-6 rounded-full bg-green-600 flex-shrink-0 flex items-center justify-center text-[10px] text-white font-bold shadow-md shadow-green-500/20">⚡</div>
                <div className="bg-green-950/80 text-green-100 p-2.5 rounded-2xl rounded-tr-sm border border-green-500/30 leading-relaxed shadow-md">
                  ...
                  <div className="flex items-center justify-between text-[10px] text-green-400/80 mt-1.5 pt-1 border-t border-green-800/40">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl">
            {[
              { icon: '⚡', title: '24/7 AI Smart Agent', desc: 'Autonomous conversations, intent detection, and seamless human handoff.' },
              { icon: '👁', title: 'Vision Lead Extractor', desc: 'Extract business cards, phone numbers, and directory listings using AI-powered vision.' },
              { icon: '📢', title: 'Targeted Broadcasts', desc: 'Launch personalized WhatsApp campaigns with scheduling and delivery safeguards.' },
              { icon: '🔐', title: 'Enterprise Security', desc: 'Protected by Supabase authentication, encrypted sessions, and Row Level Security.' },
            ].map(f => (
              <div key={f.title} className="p-4 rounded-xl bg-[#0F172A]/60 border-2 border-slate-700/60 hover:border-green-500/40 transition-all group">
                <div className="flex items-center gap-2.5 text-green-400 mb-1.5">
        ...
        <div className="lg:col-span-5 order-1 lg:order-2">
          <div className="w-full bg-[#0F172A]/95 backdrop-blur-2xl border-2 border-slate-700/70 rounded-2xl p-6 sm:p-9 shadow-2xl shadow-black/60 relative">
            {/* Top glow accent */}
            <div className="absolute -top-[1px] left-1/4 right-1/4 h-[2px] bg-gradient-to-r from-transparent via-green-400/70 to-transparent" />
            ...
            {mode === 'verify-email' && (
              <div className="text-center space-y-5">
                ...
                <div className="bg-[#0F172A]/80 border border-slate-700/60 rounded-xl p-4 text-xs text-slate-400 text-left space-y-1">
                ...
                <div className="space-y-3 pt-1">
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl font-semibold text-sm bg-green-500 hover:bg-green-400 text-[#052E16] border-b-2 border-green-700 shadow-lg shadow-green-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    className="w-full text-xs text-slate-400 hover:text-green-400 transition-colors py-1"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-3 px-4 rounded-xl font-semibold text-sm text-[#052E16] bg-green-500 hover:bg-green-400 border-b-2 border-green-700 shadow-lg shadow-green-500/25 active:scale-[0.99] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 rounded-xl bg-[#0F172A]/80 border text-white text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all ${errors.fullName ? 'border-red-500' : 'border-slate-700 focus:border-green-500'}`}
                        />
                      </div>
                      {err('fullName')}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 rounded-xl bg-[#0F172A]/80 border text-white text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all ${errors.email ? 'border-red-500' : 'border-slate-700 focus:border-green-500'}`}
                      />
                    </div>
                    {err('email')}
                  </div>
                  ...
                  {mode !== 'forgot' && (
                    <PasswordField
                      ...
                      action={mode === 'signin' && (
                        <button type="button" onClick={() => switchMode('forgot')} className="text-xs text-green-400 hover:text-green-300 hover:underline transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">
                          Forgot password?
                        </button>
                      )}
                    />
                    ...
                    <div>
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input
                          ...
                          className="mt-0.5 w-4 h-4 rounded border-slate-700 bg-[#0F172A] text-green-500 focus:ring-green-500/50 focus:ring-2 flex-shrink-0"
                        />
                  ...
                  {mode === 'forgot' && (
                    <div className="text-center space-y-2 pt-1">
                      ...
                      <button type="button" onClick={() => switchMode('signin')} className="text-xs text-slate-400 hover:text-green-400 transition-colors">
                        ← Back to Sign In
                      </button>
                    </div>
                  )}
                  ...
                  <div className="mt-5 text-center text-xs text-slate-400">
                    {mode === 'signin' ? (
                      <>
                        ...
                        <button type="button" onClick={() => switchMode('signup')} className="font-semibold text-green-400 hover:text-green-300 hover:underline transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">
                          Create account
                        </button>
                      </>
                    ) : (
                      <>
                        ...
                        <button type="button" onClick={() => switchMode('signin')} className="font-semibold text-green-400 hover:text-green-300 hover:underline transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400">
                          Sign in
                        </button>
                      </>
                    )}
            ...
            {/* Card footer */}
            <div className="mt-8 pt-5 border-t border-slate-700/60 flex items-center justify-center gap-2 text-[11px] text-slate-500">
              <svg className="w-3.5 h-3.5 text-green-400/80" fill="currentColor" viewBox="0 0 20 20">
